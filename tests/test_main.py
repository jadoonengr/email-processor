...
def test_process_emails_success_with_attachments(
    ...
    mock_read_email.assert_called_once_with(mock_services["gmail_service"], "email123")
    ...
    mock_mark_read.assert_called_once_with(mock_services["gmail_service"], "email123")
...
def test_process_emails_real_api_calls(
    mock_cloud_event,
):
    """Test using real API calls but fake cloud event."""
    # Call the function
    process_emails(mock_cloud_event)
